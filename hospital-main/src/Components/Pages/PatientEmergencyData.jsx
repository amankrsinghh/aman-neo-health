...
function PatientEmergencyData() {
    ...
    async function getAppointmentData() {
        setLoading(true)
        try {
            const result = await getSecureApiData(`appointment/hospital/${userId}?page=${currentPage}&deptType=EMERGENCY&search=${search}&startDate=${startDate}&endDate=${endDate}&statuses=${status}&doctorId=${doctorId}`)
            if (result.success) {
