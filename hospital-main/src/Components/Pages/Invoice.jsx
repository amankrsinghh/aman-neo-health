...
function Invoice() {
  ...
  // ─── subTotal — naye schema se, single useEffect ─────────────
  useEffect(() => {
    ...
    if (appointmentData?.invoiceId) {
      ...
      // ✅ tests[].categoryPrice ya tests[].subCat[].subCatPrice
                ...
                <div className="new-invoice-card">
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-3">
                    ...
                    {appointmentData?.invoiceId && (
                      <button className="print-btn no-print" onClick={handleReportDownload}>
