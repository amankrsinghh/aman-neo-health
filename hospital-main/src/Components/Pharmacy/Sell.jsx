...
function Sell() {
    ...
    const fetchSellData = async () => {
        try {
            const response = await getSecureApiData(`pharmacy/sell/${userId}?page=${currentPage}&search=${name}&schedule=${schedule}&onlySell=true&startDate=${startDate}&endDate=${endDate}&sort=${sort}`);
            if (response.success) {
        ...
        <>
            <div className="main-content flex-grow-1 p-3 overflow-auto">
                ...
                <div className="d-none">
                    ...
                    <PharmacyReturn sellId={returnLoading} pdfLoading={returnLoading} endLoading={()=>setReturnLoading()}/>
