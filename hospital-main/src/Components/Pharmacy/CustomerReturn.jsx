    ...
    const handleAddReturn = () => {
        setFormData({
            ...
            returnProducts: [...(formData.returnProducts || []), {
                inventoryId: null, quantity: 1, reason: '',
                condition: '',
                refundAmount: null,
            }]
        })
                                ...
                                <div className="row">
                                    <div className="col-lg-4 col-md-6 col-sm-12">
                                        <div className="custom-frm-bx">
                                            ...
                                            <div className="select-wrapper">
                                                <select name="" id="" disabled={haveReturns} className="form-select custom-select" value={formData?.refundStatus} onChange={(e) => setFormData({ ...formData, refundStatus: e.target.value })} >
                                    ...
                                    <div className="col-lg-4 col-md-6 col-sm-12">
                                        <div className="custom-frm-bx">
                                            ...
                                            <div className="select-wrapper">
                                                <select name="" id="" disabled={haveReturns} className="form-select custom-select" value={formData?.refundMode} onChange={(e) => setFormData({ ...formData, refundMode: e.target.value })}  >
                                    ...
                                    <div className="col-lg-4 col-md-6 col-sm-12">
                                        <div className="custom-frm-bx">
                                            ...
                                            <input type="date" disabled={haveReturns} max={new Date().toISOString().split("T")[0]} className="form-control" name="returnDate" onChange={(e) => setFormData({ ...formData, returnDate: e.target.value })} value={formData.returnDate} id="" />
